...
<html lang="en">
	...
	<body>
		<form action="<%=basePath%>deliver/update.do" name="updateForm" id="updateForm" method="post">
			<input type="hidden" name="id" value="${deliver.id}" />
			<div id="zhongxin">
				<table id="table_report" class="table table-striped table-bordered table-hover">
					<tr>
						<td style="text-align: right;padding-top: 13px;">快递公司编号:</td>
						<td><input type="text" name="deliverNo" value="${deliver.deliverNo}" required /></td>
						<td style="text-align: right;padding-top: 13px;">快递公司名称:</td>
						<td><input type="text" name="deliverName" value="${deliver.deliverName}" required /></td>
					</tr>
					<tr>
